...
###################################################---adding
            ...
            if layer['pooling_param']['pool'] == 'AVE':
                ...
                if 'kernel_size' in layer['pooling_param']:
                    ...
                    block['kernel_h'] = layer['pooling_param']['kernel_h']
                    block['kernel_w'] = layer['pooling_param']['kernel_w']
...
#                i = i + 2
            ...
            sindex =0
            for top_num in layer['top']:
                block = OrderedDict()
                block['name'] = layer['name']
                block['type'] = 'slice'
                if 'axis' in layer['slice_param']:
                    block['slice_axis']=layer['slice_param']['axis']
                block['slice_num']=len(layer['top']) - 1
                block['slice_pos']=sindex
                block['slice_points']=sindex
                sindex+=1
                layer_id[top_num] = len(blocks)
                #blocks.append(block)
                if top_num != layer['top'][0]:
                    #block = OrderedDict()
                    #block['type'] = 'route'
                    block['from'] = str(layer_id[layer['bottom']] - len(blocks)+1)
                    print("route", layer_id[layer['bottom']], len(blocks), block['from'])
                blocks.append(block)
            i = i + 1
            ...
            for bottom_num in layer['bottom']:
                #assert(layer_id[bottom_num] == len(blocks)-1)
                if bottom_num.find('view') > -1:
                    #route_layers += str(layer_id[layers[layer_id[bottom_num]]['bottom']] - len(blocks))+","
                    route_layers += str(layer_id[bottom_num] - len(blocks) -1)+","
                else:
...
#    weightfile = sys.argv[4]
    ...
    #protofile = '/home/hup/project/ReID/reidS/pytorch2caffe_MGN/PED_EXT_006.prototxt'
    #caffemodel = '/home/hup/project/ReID/reidS/pytorch2caffe_MGN/PED_EXT_006.caffemodel'
    #cfgfile = '/home/hup/project/ReID/reidS/pytorch2caffe_MGN/PED_EXT_006.cfg'
    #weightfile = '/home/hup/project/ReID/reidS/pytorch2caffe_MGN/PED_EXT_006.weights'

    #protofile = '/home/hup/project/ReID/pytorch2caffe_MGN/reid008.prototxt'
    #caffemodel = '/home/hup/project/ReID/pytorch2caffe_MGN/reid008.caffemodel'
    #cfgfile = '/home/hup/project/ReID/pytorch2caffe_MGN/reid008.cfg'
    #weightfile = '/home/hup/project/ReID/pytorch2caffe_MGN/reid008.weights'
    ...
    #protofile = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid.prototxt'
    #caffemodel = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid.caffemodel'
    #cfgfile = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid.cfg'
    #weightfile = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid.weights'	

    #protofile = '/home/hup/project/ReID/pytorch2caffe_MGN/abnerReid.prototxt'
    #caffemodel = '/home/hup/project/ReID/pytorch2caffe_MGN/abnerReid.caffemodel'
    #cfgfile = '/home/hup/project/ReID/pytorch2caffe_MGN/abnerReid.cfg'
    #weightfile = '/home/hup/project/ReID/pytorch2caffe_MGN/abnerReid.weights'
	
    protofile = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid002.prototxt'
    caffemodel = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid002.caffemodel'
    cfgfile = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid002.cfg'
    weightfile = '/home/hup/project/ReID/pytorch2caffe_MGN/videoreid002.weights'
